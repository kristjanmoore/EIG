...
void loadXstats (FILE * Xstatsfile, Indiv * indiv_array, int numindivs,
		 int *numloaded);
...
void puttln (SNP * cupt, Indiv * indx, double theta, double lambda);
...
void killxhets (SNP ** snpmarkers, Indiv ** indivmarkers, int numsnps,
		int numindivs);
void fastdupcheck (SNP ** snpmarkers, Indiv ** indivmarkers, int numsnps,
		   int numindivs);
